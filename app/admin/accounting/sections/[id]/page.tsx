...
export default function SectionEditor({
  ...
  async function load(id: string) {
    try {
      ...
      const response = await fetch(
        `/api/admin/accounting/sections/${id}/editor`,
        {
          cache: "no-store",
        }
      )
  ...
  async function addBlock(
    ...
    try {
      ...
      const response = await fetch(
        `/api/admin/accounting/sections/${sectionId}/blocks`,
        {
          method: "POST",
          headers: {
  ...
  async function updateBlock(
    ...
    try {
      ...
      const response = await fetch(
        `/api/admin/accounting/blocks/${block.id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  async function moveBlock(
    ...
    try {
      ...
      const response = await fetch(
        `/api/admin/accounting/blocks/reorder`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
                    ...
                    {(
                      ...
                      <div className="mt-4 rounded-2xl bg-[#F7FAF8] p-4">
                              ...
                              (
                                ...
                                >
                                  ...
                                  <textarea
                                    ...
                                    onBlur={async () => {
                                      await fetch(
                                        `/api/admin/accounting/block-items/${item.id}`,
                                        {
                                          method:
                                            "PATCH",
                                          headers:
                        ...
                        <button
                          ...
                          onClick={async () => {
                            await fetch(
                              `/api/admin/accounting/blocks/${block.id}/items`,
                              {
                                method:
                                  "POST",
                                headers: {
...
function IllustrationEditor({
  ...
  async function load() {
    try {
      ...
      const response = await fetch(
        `/api/admin/accounting/blocks/${block.id}/illustration`,
        {
          cache: "no-store",
        }
      )
...
function TableEditor({
  ...
  async function save() {
    try {
      ...
      const response = await fetch(
        `/api/admin/accounting/blocks/${block.id}/table`,
        {
          method: "POST",
          headers: {
            "Content-Type":
