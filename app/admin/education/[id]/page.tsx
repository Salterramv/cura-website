...
export default function EducationTopicAdmin({
  ...
  async function load(id: string) {
    try {
      ...
      const response = await fetch(
        `/api/admin/education/topics/${id}/sections`,
        { cache: "no-store" }
      )
  ...
  async function addSection() {
    ...
    try {
      ...
      const response = await fetch(
        `/api/admin/education/topics/${topicId}/sections`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <main className="min-h-screen bg-[#F6FAF8] px-6 py-10">
      ...
      <header className="-mx-6 -mt-10 mb-8 bg-[#061B3D] text-white">
          ...
          <div className="mt-5">
            ...
            <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-center">
              {editingTopic ? (
                ...
                <>
                  <h1 className="text-3xl font-bold text-[#071B49]">
                    {loading
                      ? "Loading…"
                      : topic?.title ||
                        "Education Topic"}
                ...
                (section, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Link
                        href={`/admin/education/sections/${section.id}`}
